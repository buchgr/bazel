...
import com.google.devtools.build.lib.runtime.CommonRemoteAndBesOptions;
import com.google.devtools.common.options.Option;

/** Options for remote execution and distributed caching. */
public final class RemoteOptions extends CommonRemoteAndBesOptions {
  @Option(
  ...
  @Option(
    ...
    defaultValue = "",
    category = "remote",
    help = "Value to pass as instance_name in the remote_execution API."
  )
