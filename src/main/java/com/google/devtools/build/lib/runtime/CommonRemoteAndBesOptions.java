...
/**
 * Common command line options for {@link com.google.devtools.build.lib.remote.RemoteOptions} and
 * {@link com.google.devtools.build.lib.blaze.google.buildeventservice.BuildEventServiceOptions}.
 */
public class CommonRemoteAndBesOptions extends OptionsBase {
  @Option(
      name = "auth_enabled",
      defaultValue = "false",
      category = "remote",
  ...
  @Option(
      name = "experimental_tls_authority_override",
      defaultValue = "null",
      category = "remote",
